        ...
        <Container fluid>
          <div className="navbar-wrapper">
            ...
            <ul className="navbar-nav">
                        <li ><NavLink to="/encimeras" className = "nav-link">Tienda</NavLink></li>
                        <li ><NavLink to="/galeria" className = "nav-link">Galeria</NavLink></li>
                        <li ><NavLink to="/micuenta" className = "nav-link">Mi cuenta</NavLink></li>
                    </ul>
            </Navbar.Brand>
          </div>
          <button
